...
import { getPressCoverage , getCompanyInfo } from "@/lib/data";
          ...
          <Reveal delay={80}>
            <div className="mt-10 grid gap-5 md:grid-cols-2">
              <Card className="flex flex-col gap-4 p-7">
                ...
                <ButtonLink href="mailto:${sirket.email}?subject=Bas%C4%B1n%20kiti%20talebi"
              ...
              <Card className="flex flex-col gap-4 p-7">
                ...
                <ButtonLink href="mailto:${sirket.email}" variant="solid" size="lg" className="self-start">
                  <Icon icon={IconMail} size={17} />${sirket.email}
                </ButtonLink>
              </Card>
            </div>
          </Reveal>
