        ...
        <Container>
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <Reveal className="flex flex-col gap-5">
              <Eyebrow className="text-green">SÜREÇ</Eyebrow>
              ...
              <ol className="flex flex-col gap-4">
                {[
                  ...
                  <li key={t} className="flex gap-4">
                    <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-green text-[13px] font-bold text-on-green">{i + 1}</span>
            ...
            <Reveal delay={80}>
              <Card className="flex flex-col gap-4 p-7">
                ...
                <ul className="flex flex-col gap-3">
                  {[
                    ...
                    <li key={t} className="flex items-start gap-3 text-[14.5px] leading-[1.6] text-ink2">
                      <Icon icon={IconCheck} size={17} className="mt-[3px] shrink-0 text-green" />{t}
                    </li>
                  ))}
                </ul>
                ...
                <ButtonLink href="mailto:gonullu@cocuktribunu.org" variant="green" size="lg">
