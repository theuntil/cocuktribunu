  ...
  return (
    <Card className="flex flex-col gap-5 p-6 sm:p-7">
      ...
      <form action={action} className="flex flex-col gap-4">
        ...
        <Field label="E-posta" htmlFor="pEmail" hint="değiştirilemez">
        ...
        <div className="pt-1">
          <Button type="submit" variant="green" size="lg" loading={pending}>Değişiklikleri kaydet</Button>
        </div>
      </form>
    </Card>
  );
...
export function DangerZone({ purgeAfter, requestedAt }: { purgeAfter: string | null; requestedAt: string | null }) {
  ...
  if (purgeAfter || requestedAt) {
    return (
      <Card className="flex flex-col gap-4 border-danger p-6 sm:p-7">
        ...
        <Button variant="green" size="lg" loading={cancelling}
  ...
  return (
    <Card className="flex flex-col gap-4 p-6 sm:p-7">
      ...
      <Link href="/kvkk" className="self-start text-[13.5px] font-semibold text-green hover:underline">
