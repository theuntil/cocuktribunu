...
import { approvePayment, rejectPayment, approveDonation, rejectDonation } from "@/lib/actions/admin";
      ...
      {rejectOpen ? (
        ...
        <div className="flex flex-wrap gap-2">
          <form action={doApprove}>
            <input type="hidden" name={idName} value={id} />
            <Button type="submit" variant="green" size="sm" loading={approving}>
...
export function DonationReviewRow({ donationId }: { donationId: string }) {
  return <ReviewControls idName="donationId" id={donationId} approveAction={approveDonation} rejectAction={rejectDonation} />;
}
