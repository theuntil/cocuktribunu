      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            className="h-1.5 w-full cursor-pointer appearance-none rounded-full bg-chip accent-[var(--green)]"
          />
          <Icon icon={IconImage} size={21} className="shrink-0 text-muted" />
        </div>

        <div className="flex flex-col gap-2.5 sm:flex-row-reverse">
          <Button variant="green" size="lg" onClick={crop} loading={busy} className="flex-1">
            Tamam, kaydet
          </Button>
