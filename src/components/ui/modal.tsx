      ...
      <div className="flex flex-col gap-3 sm:flex-row-reverse">
        <button
          ...
          className={cn(
            ...
            tone === "danger" ? "bg-danger" : "bg-green",
          )}
        >
        ...
        <button
          ...
          className="inline-flex flex-1 items-center justify-center rounded-full border border-line bg-surface px-5 py-3 text-[14.5px] font-semibold text-ink transition-colors hover:border-green disabled:opacity-60"
        >
          {cancelLabel}
        </button>
      </div>
