...
type ButtonVariant = "solid" | "green" | "lime" | "outline" | "ghost" | "orange" | "danger";
...
const BTN_VARIANT: Record<ButtonVariant, string> = {
  ...
  green: "bg-green text-on-green hover:opacity-90",
  lime: "bg-lime text-on-lime hover:opacity-90",
  orange: "bg-orange text-white hover:opacity-90",
  outline: "border border-line bg-surface text-ink hover:border-green hover:text-green",
