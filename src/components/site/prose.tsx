  ...
  return (
    <div
      className={cn(
        ...
        "[&_p]:mb-4",
        "[&_ul]:mb-4 [&_ul]:flex [&_ul]:flex-col [&_ul]:gap-2 [&_ul]:pl-5 [&_ul]:list-disc [&_ul]:marker:text-green",
        "[&_ol]:mb-4 [&_ol]:flex [&_ol]:flex-col [&_ol]:gap-2 [&_ol]:pl-5 [&_ol]:list-decimal [&_ol]:marker:text-green",
        "[&_a]:font-semibold [&_a]:text-green hover:[&_a]:underline",
        ...
        "[&_blockquote]:my-5 [&_blockquote]:border-l-[3px] [&_blockquote]:border-green [&_blockquote]:pl-4 [&_blockquote]:text-ink",
        className,
      )}
    >
      {children}
